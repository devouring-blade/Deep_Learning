...
hidden_1 = LSTM(n_hidden, return_sequences= True)(x_input)
hidden_2 = Bidirectional(LSTM(n_hidden, return_sequences= True), merge_mode= "concat")(hidden_1)
y_output = TimeDistributed(Dense(n_output))(hidden_2)
