...
hidden_1 = Bidirectional(LSTM(n_hidden, return_sequences= True), merge_mode= "concat")(x_input)
hidden_2 = Bidirectional(LSTM(n_hidden), merge_mode= "concat")(hidden_1)
y_output = Dense(n_output)(hidden_2)
